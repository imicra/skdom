 ...
 */
function skdom_repeater_register( $wp_customize ) {
...
add_action( 'customize_register', 'skdom_repeater_register' );

if ( ! function_exists( 'skdom_sanitize_repeater' ) ) {
	/**
	 * Sanitize repeater field
	 *
	 * @param string $input Control input in json format.
	 */
	function skdom_sanitize_repeater( $input ) {
