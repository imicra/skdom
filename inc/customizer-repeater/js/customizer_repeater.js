...
function customizer_repeater_refresh_general_control_values() {
    ...
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            var page = customizer_repeater_get_html_val(jQuery(this).find('.customizer-repeater-page-control'));
            ...
            var ifont = customizer_repeater_get_html_val(jQuery(this).find('.customizer-repeater-ifamily-choice'));
            ...
            if( !customizer_repeater_item_is_empty( page ) ){
                response.page_url = page;
            }
            if( !customizer_repeater_item_is_empty( choice ) ){
                response.choice = choice;
            }
            if( !customizer_repeater_item_is_empty( ifont ) ){
                response.icon_font = ifont;
            }
...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('change', '.customizer-repeater-ifamily-choice', function () {
        jQuery(this).parent().parent().find('.social-repeater-general-control-icon').find('.icp-auto').val('');
        jQuery(this).parent().parent().find('.social-repeater-general-control-icon').find('.input-group-addon').find('i').attr('class', 'fa');
        
        if (jQuery(this).val() === 'ifamily_sk') {
            jQuery(this).parent().parent().find('.social-repeater-general-control-icon').find('.description').hide();
            jQuery(this).parent().parent().find('.social-repeater-general-control-icon').find('.ifamily-container.ifamily').removeClass('ifamily');
            jQuery(this).parent().parent().find('.social-repeater-general-control-icon').find('.ifamily-container:last').addClass('ifamily');
        }
        if (jQuery(this).val() === 'ifamily_fa') {
            jQuery(this).parent().parent().find('.social-repeater-general-control-icon').find('.description').show();
            jQuery(this).parent().parent().find('.social-repeater-general-control-icon').find('.ifamily-container.ifamily').removeClass('ifamily');
            jQuery(this).parent().parent().find('.social-repeater-general-control-icon').find('.ifamily-container:first').addClass('ifamily');
        }

        customizer_repeater_refresh_general_control_values();
        return false;
    });
    theme_conrols.on('change', '.customizer-repeater-page-control', function () {
        customizer_repeater_refresh_general_control_values();
        return false;
    });
    ...
    if(theme_conrols.find('.social-repeater-general-control-icon').length > 0) {
        theme_conrols.find('.customizer-repeater-image-control').hide();
    }
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        if (typeof th !== 'undefined') {
            ...
            if (typeof field !== 'undefined') {
                ...
                field.find('.customizer-repeater-image-choice').val('skdom_icon');
                ...
                /*Set the default value for icon family choice between fa and sk to fa*/
                field.find('.customizer-repeater-ifamily-choice').val('ifamily_fa');
                
                /*Set the default icon picker between fa and sk to fa*/
                field.find('.social-repeater-general-control-icon').find('.ifamily-container').removeClass('ifamily');
                field.find('.social-repeater-general-control-icon').find('.ifamily-container:first').addClass('ifamily');
                
                /*Show icon fa description*/
                field.find('.social-repeater-general-control-icon').find('.description').show();
                ...
                /*Remove value from page dropdown field*/
                field.find('.customizer-repeater-page-control').val('0');
