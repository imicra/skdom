<?php
/**
 * Translation functions for Featured Section Two
 *
 * @package skdom
 */
 ...
 */
function skdom_featured_two_get_default_content() {
 ...
 */
function skdom_featured_two_register_strings() {
	if ( ! defined( 'POLYLANG_VERSION' ) ) {
		return;
	}

	$default = skdom_featured_two_get_default_content();
	skdom_pll_string_register_helper( 'skdom_featured_two_content', $default, 'Featured Section Two' );
}
add_action( 'after_setup_theme', 'skdom_featured_two_register_strings', 11 );
